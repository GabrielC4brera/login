 ...
 */
public class Error7 extends javax.swing.JDialog {
        int xMouse,yMouse;
        Registro registro=new Registro();
    /**
     * Creates new form Error
     */
    public Error7(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        escritura2.setText("6 a 15 carácteres.");
        ...
        escritura1.setText("El nombre de usuario debe ser de");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Error7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Error7 dialog = new Error7(new javax.swing.JFrame(), true);
