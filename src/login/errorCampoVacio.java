...
public class errorCampoVacio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        icono.setIcon(new javax.swing.ImageIcon(getClass().getResource("/login/Errores/imagenes/icons8_Error_55px.png"))); // NOI18N
        ...
        escritura2.setText("completados.");
        ...
        escritura1.setText("Todos los campos deben estar");
        todoelpanel.add(escritura1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 60, 200, 20));

        getContentPane().add(todoelpanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 300, 170));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(errorCampoVacio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
