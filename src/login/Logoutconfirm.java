 ...
 */
public class Logoutconfirm extends javax.swing.JDialog {
        int xMouse,yMouse;
        Registro registro=new Registro();
    /**
     * Creates new form Logoutconfirm
     */
    public Logoutconfirm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        todoelpanel4 = new javax.swing.JPanel();
        BotonSalir4 = new javax.swing.JPanel();
        imagenX4 = new javax.swing.JLabel();
        ...
        todoelpanel4.setBackground(new java.awt.Color(66, 72, 96));
        todoelpanel4.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        BotonSalir4.setBackground(new java.awt.Color(215, 81, 81));
        BotonSalir4.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        BotonSalir4.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                BotonSalir4MouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                BotonSalir4MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                BotonSalir4MouseExited(evt);
            }
        });

        imagenX4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        imagenX4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/login/imagenes/icons8_Delete_17px.png"))); // NOI18N

        javax.swing.GroupLayout BotonSalir4Layout = new javax.swing.GroupLayout(BotonSalir4);
        BotonSalir4.setLayout(BotonSalir4Layout);
        BotonSalir4Layout.setHorizontalGroup(
            BotonSalir4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(imagenX4, javax.swing.GroupLayout.DEFAULT_SIZE, 20, Short.MAX_VALUE)
        );
        BotonSalir4Layout.setVerticalGroup(
            BotonSalir4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(imagenX4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 20, Short.MAX_VALUE)
        );

        todoelpanel4.add(BotonSalir4, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 10, -1, -1));
        ...
        todoelpanel4.add(barritadearriba, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 300, 10));

        icono.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        icono.setIcon(new javax.swing.ImageIcon(getClass().getResource("/login/Errores/imagenes/icons8_Exit_55px_1.png"))); // NOI18N
        todoelpanel4.add(icono, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 60, 60));
        ...
        botonAceptartexto.setText("Confirmar");
        ...
        todoelpanel4.add(botonaceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 130, -1, 30));

        escritura2.setFont(new java.awt.Font("Lucida Sans", 0, 11)); // NOI18N
        escritura2.setForeground(new java.awt.Color(255, 255, 255));
        escritura2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        escritura2.setText("sesión?                              ");
        todoelpanel4.add(escritura2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 80, 200, 20));
        ...
        escritura1.setText("¿Está seguro que desea cerrar");
        todoelpanel4.add(escritura1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 60, 200, 20));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(todoelpanel4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(todoelpanel4, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    private void BotonSalir4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotonSalir4MouseClicked
        this.dispose();        // salir al clickear
    }//GEN-LAST:event_BotonSalir4MouseClicked

    private void BotonSalir4MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotonSalir4MouseEntered
        BotonSalir4.setBackground(new java.awt.Color(222,114,114)); //brillo del boton de salir al tocar mouse
    }//GEN-LAST:event_BotonSalir4MouseEntered

    private void BotonSalir4MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotonSalir4MouseExited
        BotonSalir4.setBackground(new java.awt.Color(215,81,81));       // se va el brillo cuando se va el mouse
    }//GEN-LAST:event_BotonSalir4MouseExited
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Logoutconfirm dialog = new Logoutconfirm(new javax.swing.JFrame(), true);
