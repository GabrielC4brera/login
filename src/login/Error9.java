 ...
 */
public class Error9 extends javax.swing.JDialog {
        int xMouse,yMouse;
        Registro registro=new Registro();
    /**
     * Creates new form Error
     */
    public Error9(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        icono.setIcon(new javax.swing.ImageIcon(getClass().getResource("/login/Errores/imagenes/icons8_Remove_User_Male_55px.png"))); // NOI18N
        ...
        escritura1.setText("El usuario y la contraseña no");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Error9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Error9 dialog = new Error9(new javax.swing.JFrame(), true);
