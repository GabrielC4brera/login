 ...
 */
public class Error5 extends javax.swing.JDialog {
        int xMouse,yMouse;
        Registro registro=new Registro();
    /**
     * Creates new form Error
     */
    public Error5(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        icono.setIcon(new javax.swing.ImageIcon(getClass().getResource("/login/Errores/imagenes/icons8_ID_not_Verified_55px_1.png"))); // NOI18N
        ...
        escritura2.setText("Sólo debe ingresar números.");
        ...
        escritura1.setText("No ha ingresado una cédula válida.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Error5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Error5 dialog = new Error5(new javax.swing.JFrame(), true);
